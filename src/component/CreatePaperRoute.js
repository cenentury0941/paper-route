...
function CreatePaperRoute()
{
    ...
    <div className={"Button " + ( stage == 0 ? "Current" : "Done" )} ><h1>Create</h1></div>
    <div className={"Button " + ( stage == 0 ? "Inactive" : ( stage == 1 ? "Current" : "Done" ) )} ><h1>Identify</h1></div>
    <div className={"Button " + ( stage == 0 ? "Inactive" : ( stage == 1 ? "Inactive" : ( stage == 2 ? "Current" : "Done" ) ) )} ><h1>Register</h1></div>
    ...
    <div className="Scroller HideOverflow" style={{ transform : "translateY("+ ( stage == 0 ? "0%" : ( stage == 1 ? "-100%" : ( stage == 2 ? "-200%" : "-300%") ) ) +")" }}  >
            ...
            <div className="Container Blank AlignCenter" >
                ...
                <h3 className="SmallHeading Dark NoShadow NoMargin">Specify Email Id</h3>
                <h4 className="SubHeading Dark NoShadow">Specify the email id that you want to receive your PaperRoute updates on</h4>
            ...
            <div className="Container Blank AlignCenter" >
                ...
                <h3 className="SmallHeading Dark NoShadow NoMargin">Identify your interests</h3>
                <h4 className="SubHeading Dark NoShadow">Specify your interests and what you'd like us to find for you.</h4>
            ...
            <div className="Container Blank AlignCenter" >
                ...
                <h3 className="SmallHeading Dark NoShadow NoMargin">Register Your PaperRoute</h3>
                <h4 className="SubHeading Dark NoShadow">Verify your details and proceed to register your PaperRoute!</h4>
            ...
            <div className="Container Blank AlignCenter" >
                ...
                success ? (
                    ...
                    <div>
                    <h3 className="SmallHeading Dark NoShadow NoMargin">Unable to create PaperRoute</h3>
                    <h4 className="SubHeading Dark NoShadow">Unfortunately an error occured when creating your paper route. Please try again later.</h4>
                    </div>
    ...
    <div className="ErrorBox" style={{ display : ( showError ? "flex" : "none" ) }}>
        <div className="ErrorMessage">
            ...
            <h4 className="SubHeading Dark NoShadow">A PaperRoute has already been created for this email!</h4>
...
export default CreatePaperRoute;